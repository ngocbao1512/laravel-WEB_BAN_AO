      ...
      <div class="float-center">
        ...
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          <div class="row tm-edit-product-row">
              ...
              <form action="" method="post" class="tm-edit-product-form">
                ...
                <div class="row">
                  <div class="form-group  col-xs-12 col-sm-6">
                    ...
                    <input id="price" name="price" type="text" value="$100" class="form-control validate" />
                  </div>
                  <div class="form-group  col-xs-12 col-sm-6">
                    <label for="sale_off"><b>Sale Of</b></label>
                    <input id="sale_off" name="sale_off" type="text" value="10%" class="form-control validate" />
                  </div>
                </div>
                <hr>
                <div class="form-group ">
                  <label for="description"><b>Description</b></label>
                  <textarea class="form-control validate tm-small" rows="3" required>Red Shirt</textarea>
                </div>
            ...
            <div class="col-12">
              <a  herf="/products" type="button" class="btn btn-primary btn-block text-uppercase" style="color:white">Edit Product</a>
            </div>
            </form>
          </div>
        </div>
