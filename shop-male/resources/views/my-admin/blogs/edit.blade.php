    ...
    <div class="row" >
        ...
        <div class="col-9" style="min-height: 70vh">
            <div class="float-center">
                <p class="tm-block-title d-inline-block float-center" style="font-size: 30px">Update Blog {{$blog->title}}</p>
            </div>
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <form action="{{route('admin.blogs.update',['blog' => $blog->id])}}" method="POST" class="tm-edit-product-form" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                <div class="row tm-edit-product-row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <input id="title" name="title" type="text"  placeholder="Title Post" class="form-control validate" value="{{$blog->title}}"/>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control validate" style="resize: none" class="form-control" cols="30" rows="20" placeholder="Enter descreption" name="content">
                                    {{$blog->content}}
                                </textarea>
                            </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                    <textarea class="form-control validate" id="taginput" cols="2" rows="5" placeholder="tag1|tag2.......|tagn.." name="tag">
                                        {{$str}}
                                    </textarea>
                                </div>
                            </div>

                            <button  type="submit" class="btn btn-primary btn-block text-uppercase" style="color:white">Update Blog</button>
                    </div>
                </form>
                </div>
            </div>
