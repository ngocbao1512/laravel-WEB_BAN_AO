          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="/index-u" class="nav-link">
                <i class="nav-icon fas fa-users"></i>&ensp;
                  <p>User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/products" class="nav-link">
                <i class=" nav-icon fab fa-cuttlefish"></i>&ensp;
                  <p>Categories</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/products" class="nav-link">
                <i class="nav-icon fab fa-paypal"></i>&ensp;
                  <p>Products</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/products" class="nav-link">
                <i class="nav-icon fas fa-tshirt"></i>&ensp;
                  <p>Brands</p>
                </a>
              </li>
